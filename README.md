...
### :memo: Guidelines
 ...
 - :bug: Bugs & feature requests should be opened on the relevant issue tracker (i.e., on the issue tracker of the corresponding [GitHub](https://github.com/GabrielCrackPro/) repository).
...
### *What language ?*
- [In English :gb::us:](https://github.com/GabrielCrackPro/ama)
- [In Spanish :es:](https://github.com/GabrielCrackPro/ama)
